...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Get all elements that should be scrambled
  ...
  allElements.forEach((el, index) => {
    ...
    if (isH1) {
      HoloqVFX.Scramble.h1(el, true, scrambleOptions);
    } else {
      HoloqVFX.Scramble.full(el, true, scrambleOptions);
    }
  });
